...
function QAndA() {
  ...
  const getItems = () => [
    ...
    },
    {
      key: '3',
      label: 'A-LEVEL课程有哪些?',
      children: <p>A-Level课程涵盖范围广泛，一共有70多门课程可以选择:数学类:数学、进阶数学理工类:物理、化学、生物社会科学类:地理、会计、商科、经济、心理等……在中国一般开设数学、物理、计算机学、化学、生物、经济学等科目。A-Level分为两个阶段。第一个阶段为AS阶段:学生可以选择3-5门课程，通过考试后获得AS证书，AS占A-Level成绩的50%。第二个阶段为A2阶段: 学生一般选择3-4门课继续学习(可以选择放弃自己学习比较困难的课程，或者保留所有课程继续学习)通过考试后获得A-Level证书，A2成绩占A-Level的50%(大部分学生选3门课即可)。</p>,
    },
    {
      key: '4',
      label: 'A-LEVEL的考试时间?',

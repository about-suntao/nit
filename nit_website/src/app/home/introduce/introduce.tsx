...
function Introduce() {
  const str = "NINGBO MANAGERS' ACADEMY  A-LEVEL CENTRE"
  return (
    <section className={styles.pages}>
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <p>宁波经理学院A-Level国际课程项目依托985名校资源，为学生提供优质教育和名校录取保障。项目在校内进行1-2年的培养，学生享受与统招生相同的优质教育资源。项目提供全方位的学术支持和丰富的学习环境，帮助学生提升综合能力，适应国际教育。 </p>
